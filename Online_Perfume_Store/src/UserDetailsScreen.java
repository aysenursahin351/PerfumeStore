...
public class UserDetailsScreen extends JDialog {
	...
	public UserDetailsScreen(ShopController c) {
		...
		contentPanel.setLayout(gbl_contentPanel);
		{
			...
			lblFullName.setBackground(Color.pink);
